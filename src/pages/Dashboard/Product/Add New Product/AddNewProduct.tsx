...
import { createProductAsync } from '../../../../store/productReducer'
...
const AddNewProduct = () => {
    ...
    const [selectedProductImage, setSelectedProductImage] = useState<IMedia>()
    const [selectedProductGallery, setSelectedProductGallery] =
        useState<Array<IMedia>>()
    ...
    const clickActionHandler = () => {
        ...
        //3) No error, proceed with creating form data
        ...
        if (selectedProductGallery && selectedProductGallery.length > 0)
            formData.append(
                `image_gallery`,
        ...
        //4) Dispatch action to create a product
        dispatch(
            createProductAsync({
                formData,
                cb: (res) => {
                ...
                <Stack flex={1}>
                    {showAlert && (
                        <Alert
                            ...
                            severity={errors.create ? 'error' : 'success'}
                            variant="outlined"
